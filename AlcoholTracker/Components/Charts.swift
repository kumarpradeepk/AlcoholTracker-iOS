            ...
            ZStack(alignment: .bottom) {
                HStack(alignment: .bottom, spacing: 3) {
                    ForEach(buckets) { b in
                        ...
                        .fill(useOverColor && b.overDaily ? theme.amber : theme.tide)
                ...
                if let averageFraction {
                    Line()
                        .stroke(theme.ter, style: StrokeStyle(lineWidth: 1.5, dash: [5, 4]))
                        .frame(height: 1.5)
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            ZStack {
                ...
                .stroke(theme.tide, style: StrokeStyle(lineWidth: 2.5, lineCap: .round, lineJoin: .round))
            }
        }
        .frame(height: height)
    }
